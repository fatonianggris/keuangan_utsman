            ...
            <div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
                ...
                <ul class="menu-nav">
                    ...
                    <?php if ($user[0]->id_role_struktur == 5) { ?>
                        <li class="menu-item menu-item-submenu menu-item-rel <?php echo @$nav_in; ?>" data-menu-toggle="click" aria-haspopup="true">
                                        ...
                                        <div class="menu-submenu menu-submenu-classic menu-submenu-right">
                                            <ul class="menu-subnav">
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="<?php echo site_url("/finance/income/list_income_du") ?>" class="menu-link">
                                                ...
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="<?php echo site_url("/finance/income/list_income_dpb") ?>" class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot">
                                                            <span></span>
                                                        </i>
                            ...
                            <ul class="menu-subnav">
                                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover" aria-haspopup="true">
                                    ...
                                    <div class="menu-submenu menu-submenu-classic menu-submenu-right">
                                        <ul class="menu-subnav">
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="<?php echo site_url("/finance/outcome/list_outcome") ?>" class="menu-link">
                                                    <i class="menu-bullet menu-bullet-dot">
                                                        <span></span>
                                                    </i>
                                            ...
                                            <?php if ($user[0]->id_role_struktur == 7 || $user[0]->id_role_struktur == 5) { ?>
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="<?php echo site_url("/finance/outcome/add_nota_outcome") ?>" class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot">
                                                            <span></span>
                                                        </i>
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <?php } else { ?>
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover" aria-haspopup="true">
                                            ...
                                            <div class="menu-submenu menu-submenu-classic menu-submenu-right">
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="<?php echo site_url("/finance/budget/list_budget_fondation") ?>" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
                                                                <span></span>
                                                            </i>
                                                    ...
                                                    <?php if ($user[0]->id_role_struktur == 4 || $user[0]->id_role_struktur == 5 || $user[0]->id_role_struktur == 6 || $user[0]->id_role_struktur == 9) { ?>
                                                        <li class="menu-item" aria-haspopup="true">
                                                            <a href="<?php echo site_url("/finance/budget/add_budget_fondation") ?>" class="menu-link">
                                                                <i class="menu-bullet menu-bullet-dot">
                                                                    <span></span>
                                                                </i>
                                    ...
                                    <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover" aria-haspopup="true">
                                        ...
                                        <div class="menu-submenu menu-submenu-classic menu-submenu-right">
                                            <ul class="menu-subnav">
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="<?php echo site_url("/finance/budget/list_budget_division") ?>" class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot">
                                                            <span></span>
                                                        </i>
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                                        ...
                                        <div class="menu-submenu menu-submenu-classic menu-submenu-right">
                                            <ul class="menu-subnav">
                                                <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                                                    <a href="<?php echo site_url("finance/settings/account/list_account") ?>" class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot">
                                                            <span></span>
                                                        </i>
                                                ...
                                                <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                                                    <a href="<?php echo site_url("finance/settings/account/add_account") ?>" class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot">
                                                            <span></span>
                                                        </i>
                                    ...
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                                        ...
                                        <div class="menu-submenu menu-submenu-classic menu-submenu-right">
                                            <ul class="menu-subnav">
                                                <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                                                    <a href="<?php echo site_url("finance/settings/email_configuration"); ?>" class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot">
                                                            <span></span>
                                                        </i>
                                                ...
                                                <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                                                    <a href="<?php echo site_url("finance/settings/account_structure_configuration"); ?>" class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot">
                                                            <span></span>
                                                        </i>
                                                ...
                                                <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                                                    <a href="<?php echo site_url("finance/settings/contact_configuration"); ?>" class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot">
                                                            <span></span>
                                                        </i>
                                                ...
                                                <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                                                    <a href="<?php echo site_url("finance/settings/general_page_configuration"); ?>" class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot">
                                                            <span></span>
                                                        </i>
        ...
        <div class="topbar">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <form>
                        <!--begin::Header-->
                        <div class="d-flex flex-column pt-10 pb-8 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(<?php echo base_url(); ?>assets/finance/dist/assets/media/misc/bg-1.jpg)">
                            <!--begin::Title-->
            ...
            <div class="dropdown ">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg p-0">
                    ...
                    <div class="navi navi-spacer-x-0 pt-3">
                        <!--begin::Item-->
                        <a href="<?php echo site_url("finance/settings/account/edit_profile/" . paramEncrypt($user[0]->id_akun_keuangan)); ?>" class="navi-item px-8">
                            <div class="navi-link">
                                <div class="navi-icon mr-2">
                        ...
                        <div class="navi-footer px-8 py-5 align-content-end">
                            <a href="<?php echo site_url("finance/auth/logout"); ?>" class="btn btn-light-danger font-weight-bold pull-right"><i class="fa fa-lock"></i>Keluar</a>
                        </div>
                        <!--end::Footer-->
                    </div>
                    <!--end::Nav-->
